...
class Invoices {
    ...
    public function createInvoice($invoice_id, $invoice_user_id, $invoice_event_id, $invoice_date){
        $sql = "INSERT INTO `invoices`(`invoice_id`, `invoice_user_id`, `invoice_event_id`, `invoice_date`) 
